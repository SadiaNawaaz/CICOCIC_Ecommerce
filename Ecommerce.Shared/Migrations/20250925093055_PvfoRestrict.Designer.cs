...
namespace Ecommerce.Shared.Migrations
{
    ...
    [Migration("20250925093055_PvfoRestrict")]
    partial class PvfoRestrict
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Shared.Entities.IntegrationUserLink", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("IntegrationUserLinks");
                });
            ...
            modelBuilder.Entity("Ecommerce.Shared.Entities.Orders.Order", b =>
                {
                    ...
                    b.Property<bool>("IsBusinessAddress")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Ecommerce.Shared.Entities.ProductVariants.ProductVariantFeatureOverride", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ProductClusterFeatureId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ProductClusterFeatureId");

                    b.HasIndex("ProductVariantId", "ProductClusterFeatureId")
                        .IsUnique();

                    b.ToTable("ProductVariantFeatureOverrides", (string)null);
                });
            ...
            modelBuilder.Entity("Ecommerce.Shared.Entities.Orders.Order", b =>
                {
                    b.HasOne("Ecommerce.Shared.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Shared.Entities.Orders.OrderItem", b =>
                {
                    b.HasOne("Ecommerce.Shared.Entities.Orders.Order", null)
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Ecommerce.Shared.Entities.ProductVariants.ProductVariantFeatureOverride", b =>
                {
                    b.HasOne("Ecommerce.Shared.Entities.Products.ProductClusterFeature", "ProductClusterFeature")
                        .WithMany()
                        .HasForeignKey("ProductClusterFeatureId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("ProductClusterFeature");
